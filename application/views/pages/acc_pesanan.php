      ...
      <div class="col-md-12">
        <div class="jumbotron">
          ...
          <!-- <div class="form-group">
            <label class="bmd-label-floating">Kode reservasi anda</label>
            <input type="text" class="form-control-plaintext text-info" name="kodereservasi"  value="" style="font-size: 1.8rem;" readonly>
          </div> -->
          <p class="lead">Pesanan anda sudah kami terima. Mohon selesaikan pembayaran dan segera upload bukti pembayaran anda di halaman profile anda.</p>
          <hr class="my-4">
