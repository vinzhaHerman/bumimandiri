...
<body>
  <div class="main-wrapper">
    ...
    <?php echo form_open('Register/daftar'); ?>
      ...
      <input type="text" placeholder="Nama Depan" name="namadepan" style="float: left; width: 41%; margin: 0 0 5px 7px">
      <?php echo form_error('namabelakang'); ?>
      <input type="text" placeholder="Nama Belakang" name="namabelakang" style="float: left; width: 41%; margin: 0 0 5px 7px">
