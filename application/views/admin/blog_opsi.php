          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div id="typography">
                ...
                <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <input type="text" name="judul" class="form-control" value="<?php echo $res['judul_post'] ?>">
                        <input type="text" name="id" class="form-control" value="<?php echo $res['id'] ?>" hidden>
                      </div>
                    </div>
                </div>
                  <div class="card-title">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <textarea name="para"><?php echo $res['isi_post'] ?></textarea>
                  </div>
                </div>
                </form>
