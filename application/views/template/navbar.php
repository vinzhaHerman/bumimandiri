<div class="navbar1">
    <span class="open-slide">
        <a href="#side-menu" onclick="openSlideMenu()">
            <img src="<?php echo base_url();?>assets/img/icons8-menu-16.png">   <p>MENU</p>
        </a>
    </span>
    <div class="navbar-nav1">
        <ul>
            <li class="right fill-button"><a href="http://localhost/PBumiMandiri/login">Masuk</a></li>
            <li class="right border-button"><a href="http://localhost/PBumiMandiri/register">Daftar</a></li>
...
<div id="side-menu" class="side-nav">
    ...
    <a href="http://localhost/PBumiMandiri/booking" class="pesan-side"><img src="<?php echo base_url();?>assets/img/">Pesan Sekarang</a>
    <a href="http://localhost/PBumiMandiri/web/bantuan"><img src="<?php echo base_url(); ?>assets/img/bantuan.png">Bantuan</a>
